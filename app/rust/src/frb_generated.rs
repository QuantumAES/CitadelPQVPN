...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1739883254;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        53 => wire__crate__api__citadel__vpn_connect_impl(port, ptr, rust_vec_len, data_len),
        54 => {
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        55 => wire__crate__api__citadel__vpn_disconnect_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
