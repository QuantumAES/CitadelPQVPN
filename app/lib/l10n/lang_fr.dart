...
const Map<String, String> langFr = {
  ...
  'pacing_off': 'Désactivé',
  'pacing_off_sub': 'Aucun trafic ni consommation de batterie supplémentaires',
  'pacing_lite': 'Économique',
  'pacing_lite_sub': 'Jusqu’à 2 Mo par heure de trafic supplémentaire ; nettement moins gourmand en batterie',
  'pacing_strict': 'Strict',
  'pacing_strict_sub': 'Jusqu’à 8 Mo par heure de trafic supplémentaire ; consommation de batterie sensible',
  'pacing_note': 'Le masquage agit tant que du trafic circule : au repos, il se tait et ne coûte rien. S’applique dès la prochaine session.',
  // ── C9 ──
  ...
  'verify_code_mismatch': 'Le code ne correspond pas : ce n\'est pas le lien émis par l\'administrateur. Ne vous connectez pas — demandez un nouveau lien.',
  'feat_one_time': 'à usage unique',
  'admin_timeout': 'Pas de réponse du serveur en 30 s. Le tunnel de ce profil est-il actif ? Si oui, voir le journal du noyau (lignes [admin]).',
