...
// P-1: интеграционный тест поднимает петлю 127.0.0.1 и к собственному туннелю отношения не
// имеет — маршрутного решения здесь нет, фабрика `citadel_protect` не нужна (clippy.toml).
